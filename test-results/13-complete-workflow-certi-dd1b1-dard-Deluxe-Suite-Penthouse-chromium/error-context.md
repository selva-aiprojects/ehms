...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 1: Property Management - Room Creation Per Workspace >> CERT-013: Hotels workspace - Room types include Standard, Deluxe, Suite, Penthouse
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:202:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    19 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
- generic [active] [ref=f92e1]:
  - paragraph [ref=f92e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f92e11] [cursor=pointer]
  - alert [ref=f92e15]
```
