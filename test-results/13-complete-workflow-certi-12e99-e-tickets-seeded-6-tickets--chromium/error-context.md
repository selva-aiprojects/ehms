...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-006: Maintenance tickets seeded (6+ tickets)
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:107:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    15 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
```yaml
- paragraph [ref=f105e5]: Loading organization...
```
