...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-005: Housekeeping tasks seeded (17+ tasks)
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:95:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    ...
    4 × navigated to "http://localhost:3000/login?tenant=VISWA"
      - waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
    - navigated to "http://localhost:3000/login?tenant=VISWA"
