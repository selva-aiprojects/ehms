...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-008: Finance chart of accounts seeded
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:130:9
...
- generic [active] [ref=f48e1]:
  - paragraph [ref=f48e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f48e11] [cursor=pointer]
```
