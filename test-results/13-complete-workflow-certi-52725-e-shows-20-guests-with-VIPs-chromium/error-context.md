...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-004: Guest profiles page shows 20+ guests with VIPs
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:75:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    16 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
- generic [active] [ref=f104e1]:
  - paragraph [ref=f104e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f104e11] [cursor=pointer]
  - alert [ref=f104e15]
```
