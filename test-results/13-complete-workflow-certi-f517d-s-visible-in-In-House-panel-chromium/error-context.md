...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-003: 8+ checked-in guests visible in In-House panel
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:62:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    5 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
      - navigated to "http://localhost:3000/login?tenant=VISWA"
    - waiting for navigation to finish...
    21 × navigated to "http://localhost:3000/login?tenant=VISWA"
