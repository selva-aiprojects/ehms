...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 1: Property Management - Room Creation Per Workspace >> CERT-012: Hotels workspace - Room creation modal has all required fields
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:182:9
...
```yaml
- paragraph [ref=f110e5]: Loading organization...
```
