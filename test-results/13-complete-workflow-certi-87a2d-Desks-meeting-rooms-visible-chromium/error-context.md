...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 1: Property Management - Room Creation Per Workspace >> CERT-016: Workplace Services workspace - Desks/meeting rooms visible
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:237:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    22 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
- generic [active] [ref=f111e1]:
  - paragraph [ref=f111e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f111e11] [cursor=pointer]
  - alert [ref=f111e15]
```
