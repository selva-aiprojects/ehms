...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 1: Property Management - Room Creation Per Workspace >> CERT-011: Hotels workspace - Room inventory page loads with room list
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:165:9
...
- generic [active] [ref=f67e1]:
  - paragraph [ref=f67e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f67e11] [cursor=pointer]
  - alert [ref=f67e15]
```
