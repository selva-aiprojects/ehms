...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-000: All 4 workspace types exist with properties
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:29:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    21 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
       - navigated to "http://localhost:3000/login?tenant=VISWA"
    - waiting for navigation to finish...
    3 × navigated to "http://localhost:3000/login?tenant=VISWA"
...
```yaml
- paragraph [ref=f121e5]: Loading organization...
```
