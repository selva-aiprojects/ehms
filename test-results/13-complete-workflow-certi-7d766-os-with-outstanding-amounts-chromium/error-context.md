...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-010: Billing shows active folios with outstanding amounts
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:150:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    13 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
       - navigated to "http://localhost:3000/login?tenant=VISWA"
    - waiting for navigation to finish...
    15 × navigated to "http://localhost:3000/login?tenant=VISWA"
...
- generic [active] [ref=f77e1]:
  - paragraph [ref=f77e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f77e11] [cursor=pointer]
  - alert [ref=f77e15]
```
