...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-007: F&B menu has 25+ items with prices
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:119:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    25 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
```yaml
- paragraph [ref=f74e5]: Loading organization...
```
