...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-002: All room statuses present (Occupied, Available, Dirty, Reserved, Maint)
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:53:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    26 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
- generic [active] [ref=f106e1]:
  - paragraph [ref=f106e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f106e11] [cursor=pointer]
```
