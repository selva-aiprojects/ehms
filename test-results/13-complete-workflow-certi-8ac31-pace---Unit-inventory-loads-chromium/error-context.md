...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 1: Property Management - Room Creation Per Workspace >> CERT-014: Serviced Apartments workspace - Unit inventory loads
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:221:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    ...
    6 × navigated to "http://localhost:3000/login?tenant=VISWA"
