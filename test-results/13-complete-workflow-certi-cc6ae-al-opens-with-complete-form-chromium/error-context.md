...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 2: Guest Booking Journey - Multiple Sources >> CERT-018: Walk-in booking modal opens with complete form
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:259:9
...
```yaml
- paragraph [ref=f35e5]: Loading organization...
```
