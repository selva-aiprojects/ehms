...
- Name: 13-complete-workflow-certification.spec.ts >> COMPLETE WORKFLOW CERTIFICATION >> PHASE 0: Seed Data Verification & Platform Readiness >> CERT-001: Room matrix shows 50 rooms (10 per floor x 5 floors)
- Location: tests\e2e\13-complete-workflow-certification.spec.ts:46:9
...
Call log:
  - waiting for locator('input[type="email"]') to be visible
    28 × waiting for "http://localhost:3000/login?tenant=VISWA" navigation to finish...
...
- generic [active] [ref=f117e1]:
  - paragraph [ref=f117e5]: Loading organization...
  - button "Open Next.js Dev Tools" [ref=f117e11] [cursor=pointer]
```
