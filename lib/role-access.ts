export const ROLE_ACCESS: Record<string, string[]> = {
  ...
  finance_manager: ["/dashboard", "/dashboard/finance", "/dashboard/procurement", "/dashboard/rental"],
  ...
  maintenance_supervisor: ["/dashboard", "/dashboard/maintenance", "/dashboard/procurement"],
