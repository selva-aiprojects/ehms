export const ROLE_ACCESS: Record<string, string[]> = {
  ...
  super_admin: [
    ...
    "/dashboard/inventory", "/dashboard/vendors",
  ],
  executive: [
    "/dashboard", "/dashboard/admin", "/dashboard/front-desk",
    "/dashboard/housekeeping", "/dashboard/maintenance", "/dashboard/finance",
  ...
  housekeeping_supervisor: ["/dashboard", "/dashboard/housekeeping", "/dashboard/inventory"],
  housekeeping_staff: ["/dashboard", "/dashboard/housekeeping"],
  maintenance_staff: ["/dashboard", "/dashboard/maintenance", "/dashboard/vendors"],
  maintenance_supervisor: ["/dashboard", "/dashboard/maintenance", "/dashboard/procurement", "/dashboard/inventory", "/dashboard/vendors"],
