export const ROLE_ACCESS: Record<string, string[]> = {
  ...
  front_desk: ["/dashboard", "/dashboard/front-desk", "/dashboard/rooms-inventory", "/dashboard/laundry", "/dashboard/front-desk/checkin", "/dashboard/front-desk/checkout", "/dashboard/restaurant"],
