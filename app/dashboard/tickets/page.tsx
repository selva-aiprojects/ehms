  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--color-navy)" }}>My Support Tickets</h1>
          <p className="text-sm" style={{ color: "var(--color-text-muted)" }}>Track and manage your support requests</p>
        </div>
      ...
      <div className="relative w-full max-w-lg rounded-2xl p-6 bg-white shadow-xl animate-slide-up">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: "var(--color-text-muted)" }}>Submit a support request</p>
          </div>
        </div>
