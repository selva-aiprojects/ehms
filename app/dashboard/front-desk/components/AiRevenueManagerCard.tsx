...
export default function AiRevenueManagerCard({ propertyId: propPropertyId }: AiRevenueManagerCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden border border-[color:var(--color-navy)]/20 shadow-md">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-[var(--color-navy)] to-[var(--color-dark-navy)] p-4 text-white flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-[color:var(--color-primary)]/20 flex items-center justify-center border border-[color:var(--color-primary)]/40">
      ...
      {loading ? (
        ...
        <div className="p-4 space-y-4 flex-1 overflow-y-auto">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-[var(--color-light)] p-3 rounded-xl border border-[var(--color-border)] flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${
                    data.demand_level === "High" ? "bg-[var(--color-danger-soft)] text-[var(--color-danger)]" : data.demand_level === "Low" ? "bg-[var(--color-info-soft)] text-[var(--color-info)]" : "bg-[var(--color-success-soft)] text-[var(--color-success-dark)]"
                  }`}>
            ...
            <div className="bg-[var(--color-success-soft)] p-3 rounded-xl border border-[color:var(--color-primary)]/30 flex items-center justify-between">
              <div>
                <p className="text-[11px] text-[var(--color-success-dark)] font-medium">Daily Revenue Lift</p>
                <div className="flex items-center gap-1 mt-0.5">
                  <span className="text-lg font-bold text-[var(--color-success-dark)]">
              ...
              <Button
                ...
                className="h-7 px-2.5 text-xs bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white"
              >
          ...
          <div className="space-y-2.5">
            <h4 className="text-xs font-semibold text-[var(--color-navy)] flex items-center justify-between">
            ...
            <div className="divide-y divide-[var(--color-border)] border rounded-xl overflow-hidden bg-white">
              {(data.recommendations || []).map((rec: any) => {
                ...
                return (
                  <div key={rec.ratePlanId} className="p-3.5 flex items-center justify-between hover:bg-[var(--color-light)] transition-colors">
