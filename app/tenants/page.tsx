  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--color-dark-navy)", color: "var(--color-light)" }}>
      ...
      <nav
        ...
        style={scrolled
          ? { background: "rgba(var(--color-dark-navy-rgb),0.92)", borderBottom: "1px solid rgba(var(--color-primary-rgb),0.15)" }
            ...
            <div className="flex items-center gap-3">
              {platformAuthed && (
                <span className="text-xs font-medium flex items-center gap-1.5 px-3 py-1.5 rounded-full"
                    style={{ background: "rgba(var(--color-gold-rgb),0.1)", color: "var(--color-gold)", border: "1px solid rgba(var(--color-gold-rgb),0.2)" }}
                >
      ...
      <section className="relative pt-28 pb-16 lg:pt-36 lg:pb-20 overflow-hidden">
        <div className="absolute inset-0 animate-gradient"
          style={{ background: "linear-gradient(-45deg, var(--color-dark-navy) 0%, var(--color-bg-surface) 25%, var(--color-navy) 50%, var(--color-dark-navy) 75%, var(--color-bg-surface) 100%)", backgroundSize: "400% 400%" }}
        />
      ...
      <section className="relative z-10 pb-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {error && (
            <div className="flex items-center justify-center gap-2 py-20 text-sm" style={{ color: "var(--color-danger)" }}>
                ...
                return (
                  <div key={tenant.id}
                    ...
                    style={{
                      ...
                      border: `1px solid ${suspended ? "rgba(var(--color-danger-rgb),0.2)" : "rgba(var(--color-primary-rgb),0.12)"}`,
                      ...
                      {verts.map((v) => {
                        ...
                        return (
                          <span key={v} className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium"
                            style={{ background: "rgba(var(--color-primary-rgb),0.08)", color: "rgba(var(--color-primary-rgb),0.8)", border: "1px solid rgba(var(--color-primary-rgb),0.12)" }}>
          ...
          <div className="mt-12 text-center">
            {platformChecking ? (
              <Loader2 className="w-5 h-5 mx-auto animate-spin" style={{ color: "var(--color-primary)" }} />
            ) : (
              <>
                <div className="mb-4">
      ...
      {showProvision && platformAuthed && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4"
          ...
          <div className="relative w-full max-w-4xl rounded-3xl p-8 animate-slide-up flex flex-col md:flex-row gap-8"
            style={{ background: "var(--color-bg-surface)", border: "1px solid rgba(var(--color-primary-rgb),0.15)", maxHeight: "90vh" }}>
                ...
                <div className="flex-1 overflow-y-auto pr-1 py-1 space-y-5 min-h-[320px] max-h-[50vh] md:max-h-[55vh]">
                    ...
                    <div className="space-y-4 animate-fade-in">
                      <div className="flex items-center justify-between">
                        ...
                        <button type="button" onClick={addWorkspace}
                          ...
                          style={{ color: "var(--color-primary)", borderColor: "rgba(var(--color-primary-rgb),0.25)" }}>
                  ...
                  {wizardStep === 3 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="p-4 rounded-2xl space-y-2 mt-4" style={{ background: "rgba(var(--color-primary-rgb),0.06)", border: "1px solid rgba(var(--color-primary-rgb),0.12)" }}>
                      ...
                      {provisionResult && (
                        <div className="rounded-lg px-4 py-2.5 text-sm flex items-center gap-2"
                          style={{ background: provisionResult.ok ? "rgba(var(--color-primary-rgb),0.1)" : "rgba(var(--color-danger-rgb),0.08)", color: provisionResult.ok ? "var(--color-primary)" : "var(--color-danger)", border: `1px solid ${provisionResult.ok ? "rgba(var(--color-primary-rgb),0.2)" : "rgba(var(--color-danger-rgb),0.2)"}` }}>
