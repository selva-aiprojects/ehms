...
const PUBLIC_ROUTES = ["/", "/tenants", "/login", "/offline", "/_next/", "/favicon.ico", "/hostsphere-logo.png", "/favicon.png", "/manifest.json", "/sw.js", "/robots.txt", "/sitemap.xml"];
...
export const config = {
  matcher: [
    "/((?!_next|favicon.ico|manifest.json|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|json|ico|txt)$).*)",
  ],
};
