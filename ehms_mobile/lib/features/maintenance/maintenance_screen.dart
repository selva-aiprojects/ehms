  ...
  Widget _buildContent() {
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: _buildStats(openCount, inProgressCount, resolvedCount),
        ),
                  ...
                  children: [
                    ...
                    if (category.isNotEmpty)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: HmsColors.info.withValues(alpha: 0.1),
